...
from utils.handwritten.field_extract import get_field, get_subfield, get_field_bbox, get_subfield_bbox
    ...
    if invoices.documents:
        for idx, invoice in enumerate(invoices.documents):
            ...
            invoice_data = {
                ...
                "invoice_total_bbox": get_field_bbox(invoice, 'InvoiceTotal'), #invoice.fields['InvoiceTotal']['boundingRegions'],
                "due_date": due_date,
                ...
                for item in invoice.fields.get("Items").value_array:
                    if item.value_object:
                        ...
                        item_data = {
                                            ...
                                            "amount_code": currency_code,
                                            "amount_symbol": currency_symbol,
                                            "amount_bbox": get_subfield_bbox(item, 'Amount'),#item.value_object['Amount']['boundingRegions'],
